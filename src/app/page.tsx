    ...
    <div className="h-screen overflow-hidden bg-background">
      <DocSidebar>
        ...
        <main className="transition-all duration-300">
          {/* Hero header */}
          <header className="relative overflow-hidden bg-linear-to-br from-brand-dark via-[#2D1A4A] to-brand-dark">
            {/* Decorative elements */}
            <div className="absolute inset-0 overflow-hidden">
              ...
              <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-150 h-150 rounded-full bg-brand-purple/5 blur-3xl" />
              {/* Grid pattern */}
              <div
            ...
            <div className="relative max-w-5xl mx-auto px-8 py-16 lg:py-24">
              ...
              <h1 className="text-4xl lg:text-5xl font-bold text-white mb-4 font-(family-name:--font-poppins) leading-tight">
                FHIR REST APIs & Bundles
              </h1>
              <p className="text-lg text-white/60 max-w-2xl leading-relaxed font-(family-name:--font-inter)">
          ...
          <div className="max-w-5xl mx-auto px-8 py-12">
            ...
            <DocSection id="search-inputs" title="Search Inputs" level={2}>
              ...
              <ul className="list-none space-y-2 my-4">
                <li className="flex items-start gap-3 bg-muted/50 dark:bg-white/4 rounded-xl px-4 py-3">
            ...
            <DocSection id="handling-errors" title="Handling Errors" level={2}>
              ...
              <div className="my-6 rounded-xl border border-border dark:border-brand-purple/10 overflow-hidden">
                <table className="w-full text-sm">
                  <thead>
                    <tr className="bg-muted/50 dark:bg-white/3">
            ...
            <DocSection id="multi-datastore" title="Multi-datastore Considerations" level={2}>
              ...
              <ol className="list-none space-y-3 my-4">
                {[
                  ...
                  <li
                    key={`limitation-${text.slice(0, 20)}`}
                    className="flex items-start gap-3 bg-muted/30 dark:bg-white/3 rounded-xl px-4 py-3"
                  >
                    <span className="inline-flex items-center justify-center w-6 h-6 rounded-lg bg-linear-to-br from-brand-purple to-brand-teal text-white text-xs font-bold shrink-0">
                      {i + 1}
                    </span>
            ...
            <DocSection id="modifiers" title="Modifiers" level={2}>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 my-4">
                {[
                  ...
                  <div
                    key={mod}
                    className="flex items-start gap-3 bg-muted/30 dark:bg-white/3 border border-border/50 dark:border-brand-purple/10 rounded-xl px-4 py-3"
                  >
...
GET [base]/Observation?value-quantity=le5.4|http://unitsofmeasure.org|mg`}
            ...
            <DocSection id="escaping" title="Escaping Search Parameters" level={2}>
              ...
              <CodeBlock
                ...
                code={String.raw`GET [base]/ValueSet?url=http://example.org/fhir/ValueSet/123\|456`}
              />
            </DocSection>
            ...
            <DocSection id="basic-parameter-types" title="Basic Parameter Types" level={2}>
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 my-4">
                {[
                  ...
                  <div
                    key={type}
                    className="bg-muted/30 dark:bg-white/3 backdrop-blur-sm border border-border/50 dark:border-brand-purple/10 rounded-xl p-4 space-y-2"
                  >
                    <div className="flex items-center gap-2">
                      <span className="w-2 h-2 rounded-full bg-brand-purple" />
                      <span className="font-semibold text-sm text-foreground font-(family-name:--font-poppins)">
                        {type}
                      </span>
                    </div>
            ...
            <DocSection id="extended-parameter-types" title="Extended Parameter Types" level={2}>
              <div className="space-y-3 my-4">
                {[
                  ...
                  <div
                    key={type}
                    className="flex items-start gap-4 bg-muted/20 dark:bg-white/3 border border-border/30 dark:border-brand-purple/10 rounded-xl p-4"
                  >
            ...
            <DocSection id="conformance-summary" title="Conformance Summary" level={2}>
              ...
              <ul className="list-none space-y-2 my-4">
                {[
                  ...
                  <li
                    key={`conformance-${item.slice(0, 20)}`}
            ...
            <footer className="mt-16 pt-8 border-t border-border dark:border-brand-purple/10">
              <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
                <div className="flex items-center gap-3">
                  <div className="w-8 h-8 rounded-xl bg-linear-to-br from-brand-purple to-brand-teal flex items-center justify-center">
                    <span className="text-white font-bold text-sm">F</span>
                  </div>
                  <div>
                    <p className="text-sm font-semibold text-foreground font-(family-name:--font-poppins)">
...
function ContextCard({
  ...
  return (
    <div className="bg-muted/30 dark:bg-white/3 backdrop-blur-sm border border-border/50 dark:border-brand-purple/10 rounded-xl p-5 space-y-3">
      <div className="flex items-center gap-2">
        <Badge className="bg-brand-purple text-white rounded-lg text-[10px]">
          {badge}
        </Badge>
        <h4 className="font-semibold text-sm text-foreground font-(family-name:--font-poppins)">
          {title}
        </h4>
      </div>
      <p className="text-sm text-muted-foreground">{description}</p>
      <div className="bg-brand-dark rounded-lg px-4 py-2.5">
...
function ModeCard({
  ...
  readonly title: string;
  readonly color: "purple" | "teal" | "neutral";
  readonly description: string;
}) {
  const colorMap = {
  ...
  return (
    <div className="bg-muted/30 dark:bg-white/3 backdrop-blur-sm border border-border/50 dark:border-brand-purple/10 rounded-xl p-4 space-y-2">
      <div className="flex items-center gap-2">
        <div
          className={`w-3 h-3 rounded-full bg-linear-to-br ${colorMap[color]}`}
        />
        <h4 className="font-semibold text-sm text-foreground font-(family-name:--font-poppins)">
          {title}
        </h4>
...
function ErrorRow({ issue, search }: { readonly issue: string; readonly search: string }) {
  return (
    <tr>
